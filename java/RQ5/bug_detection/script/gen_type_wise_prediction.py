...
oracle_preds_assertion.to_csv('assertion_prefix/oracle_preds.csv', index=False)
oracle_preds_exception.to_csv('exception_prefix/oracle_preds.csv', index=False)
oracle_preds_prefix_only.to_csv('prefix_only/oracle_preds.csv', index=False)
